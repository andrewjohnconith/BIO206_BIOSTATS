...
I want you to find the mean and median from a sample population of two closely related primate species: bonobos and chimpanzees. The data here is measurement data of the skull length and skull height. I want you to construct a data frame that includes the data below and obtain species means and medians.

Chimp skull height (cm) -  25, 35, 53, 47, 41, 61.

Chimp skull length (cm) -  45, 48, 55, 51, 49, 66.

Bonobo skull height (cm) -  34, 33, 59, 45, 64, 72.

Bonobo skull length (cm) -  43, 49, 50, 48, 54, 61.
